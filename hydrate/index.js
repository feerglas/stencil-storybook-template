...
/*!
 Stencil Mock Doc v4.0.1 | MIT Licensed | https://stenciljs.com
 */
...
const createElm = (e, t, o, n) => {
 ...
 e.$queuedListeners$ = void 0)), BUILD.cmpWillLoad ) : (BUILD.cmpWillUpdate ), n(), enqueue(l, (() => updateComponent(e, s, t)));
...
}, hostListenerOpts = e => 0 != (2 & e), insertVdomAnnotations = (e, t) => {
 if (null != e) {
  const o = {
   hostIds: 0,
   rootLevelIds: 0,
...
class MyComponent {
  constructor(hostRef) {
    ...
    this.clicked = createEvent(this, "my-component_button-clicked", 7);
