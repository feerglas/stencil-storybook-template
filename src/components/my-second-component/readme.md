...
| ------------------------------------ | -------------------------------------------------------------------------------------------------------- | ------------------- |
| `my-second-component_button-clicked` | Create a meaningful description for the event. This will be automatically rendered to the documentation. | `CustomEvent<void>` |
